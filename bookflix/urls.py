...
from gestion_usuario.views import home,welcome,register,login,logout,edit_profile,profile,index,change_profile_view,change_session_profile,register_profile,desactivar_perfil,historial,informe_usuario,borrar_comentario,terminar_lectura,terminar_capitulo,capitulo_terminado,change_password
from gestion_noticia.views import news,news_especifica,trailer,trailer_especifico
from gestion_libro.views import home_logueado,libro_especifico,libro_fav,SearchResultsView,libro_no_disponible,informe_libro,add_capitulo,edit_capitulo,dar_dislike,dar_like,borrar_puntaje, alerta, no_disponible,existente
...
urlpatterns = [
	...
	path('like/<libroId>', dar_like),
	path('dislike/<libroId>', dar_dislike),
	path('borrarpuntaje/<libroId>', borrar_puntaje),
