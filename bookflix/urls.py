...
from gestion_usuario.views import home,welcome,register,login,logout,edit_profile,profile,index,change_profile_view,change_session_profile,register_profile,desactivar_perfil,historial,informe_usuario,borrar_comentario,terminar_lectura,terminar_capitulo
...
urlpatterns = [
    ...
    path('libro/terminar_capitulo/<id_libro>', terminar_capitulo),
