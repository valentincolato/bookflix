...
def libro_especifico(request, libroId):
	...
	contexto = {"libro": l, "favorito": fav, "capitulos": caps,
				...
				,"capitulo_actual":capitulo_actual(request,l.id),"trailers":Trailer.objects.filter(libro=l),"disponibilidad":disponibilidad_libro(l),"punt": puntuar(request, libroId, None),
				"porcentaje":porcentaje_likes(libroId),"votostotales":cant_likes(libroId)}
